...
const (
	PaymentService_ProcessPayment_FullMethodName = "/v1.PaymentService/ProcessPayment"
	PaymentService_ListPayments_FullMethodName   = "/v1.PaymentService/ListPayments"
)
